<?php include('header.php');?>
      <div class="container">
         ...
         <p>La página que ahora ves se divide en 3 partes, las que se juntan en el servidor gracias a dos <a href="http://php.net/manual/es/function.include.php" target="_blank">funciones include</a>: una al principio del index.php, que incluye al header.php, y otra al final, que incluye al footer.php. ¿Qué utilidad ofrece esto? Podemos mantener el mismo header.php y footer.php, y cambiar el documento que los llama, ello es útil para generar, rápidamente, varias páginas para el mismo sitio.</p>
