...
//serie de misdatos JSON 
var misdatos = [
	{"posX" : 10, "posY" : 10, "diam" : 20, "categ" : "red", "nombre" : "juan"}, 
...
//4 - Dominio de misdatos para rango x (posicion array 1) 
...
//4 - Dominio de misdatos para rango y (posicion array 3) 
...
//crea una especie de grupo donde de elementos basados en los misdatos
var circles = grafico.append("g") 
				.classed("circles", true)
				//vincula circulos a serie de misdatos 
				.selectAll("circle")		
				.data(misdatos)
			...
			//asigna valores de misdatos para posicion x e y de bolas				
				.attr("cx", function(d) {
