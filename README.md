...
Con Playfair tenemos un visualizar. con Clarkson tenemos un visibilizar. **Visualizar es hacer visual. Visibilizar es hacer visible**. Visualizar implica presentar mediante imágenes. Visibilizar implica re-presentar mediante imágenes. El visualizar presenta, a la vista, lo que antes era invisible. El visibilizar re-presenta a la vista lo que antes ya pudo ser visto. 
